...
-- CONFIG --
roleList = { 
	['👮 LSPD | '] = {"LSPD", 2, 'https://discord.com/ap'},
	['👮 Sheriff | '] = {"Sheriff", 17, 'https://discord.com/api/webhooks/'},
	['👮 SAHP | '] = {"SAHP", 3, 'https://discord.com/api/webhooks//'},
	['👨‍🚒 Fire/EMS | '] = {"Fire/EMS", 1, 'https://discord.com/api/webhooks//'},
	['🎖️ NG | '] = {"NG", 5, 'https://discord.com/api///'},
}
